...
def data_over_time(df, col):
    ...
    print("Columns after reset_index:", nations_over_time.columns)
...
def most_successful(df, sport):
    ...
    print("Columns after reset_index:", x.columns)
    x.columns = ['Name', 'Count']
    merged_df = x.head(15).merge(df, left_on='Name', right_on='Name', how='left')
